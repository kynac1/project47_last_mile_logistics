...
# # combined boxplot
# p1<-data1 %>% 
#   ggplot(aes(x=arrival_rate, y=number_of_packages, color = arrival_rate)) + geom_boxplot() + ggtitle("number_of_packages vs collection capcity")
# p3<-data1 %>% 
#   ggplot(aes(x=arrival_rate, y=number_of_delivered_packages, color = arrival_rate)) + geom_boxplot() + ggtitle("number_of_delivered_packages vs collection arrival_rate")
# p4<-data1 %>% 
#   ggplot(aes(x=arrival_rate, y=number_of_undelivered_packages, color = arrival_rate)) + geom_boxplot() + ggtitle("number_of_undelivered_packages vs collection arrival_rate")
