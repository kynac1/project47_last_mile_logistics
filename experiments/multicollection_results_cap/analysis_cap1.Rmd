...
# par(new = T)
# with(summ, plot(collection_capacity,  avg.package_at_collecton, type="b", pch=15,  ylim = c(000, max(avg.package_at_collecton)), col="blue", axes=F, xlab=NA, ylab=NA, cex=1.2))
